...
namespace Tankooni
{
	...
	public abstract class TankooniConfig
	{
		public bool IsDebug { get; set; }

		public virtual TankooniConfig CopyAndScrubSensitiveData()
		{
			return this;
		}
	}

	public class MainConfig : TankooniConfig
	{
		...
		public override TankooniConfig CopyAndScrubSensitiveData()
		{
			var newConfig = JsonConvert.DeserializeObject<MainConfig>(JsonConvert.SerializeObject(this));
			newConfig.OverrideOauth = "";
			return newConfig;
		}
		...
		public static MainConfig CreateDefaultConfig()
		{
		...
		public static MainConfig WriteDefaultConfig()
		{
			...
			Utils.Json.JsonWriter.Save(config, MainConfigPath, false);
			return config;
		}
